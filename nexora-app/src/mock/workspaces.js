...
const SEED = [
  {
    ...
    owner: { _id: 'user_001', name: 'Tanishq Patel', email: 'demo@nexora.com' },
    members: [
      { _id: 'user_001', name: 'Tanishq Patel', email: 'demo@nexora.com', role: 'owner',  joinedAt: '2024-01-10T09:00:00.000Z' },
  ...
  },
  {
    ...
    members: [
      ...
      { _id: 'user_001', name: 'Tanishq Patel', email: 'demo@nexora.com',   role: 'admin',  joinedAt: '2024-02-06T10:00:00.000Z' },
      { _id: 'user_003', name: 'Udita Singh',   email: 'udita@nexora.com',   role: 'member', joinedAt: '2024-02-10T10:00:00.000Z' },
      { _id: 'user_004', name: 'Vidita Sharma', email: 'vidita@nexora.com',  role: 'member', joinedAt: '2024-02-12T11:00:00.000Z' },
    ],
...
export function getWorkspaces() {
  const workspaces = loadFromStorage(KEY, null);
  if (!workspaces || JSON.stringify(workspaces).includes('Sharma') || JSON.stringify(workspaces).includes('tanishq@nexora.com')) {
    saveWorkspaces(SEED);
    return SEED;
  }
  return workspaces;
